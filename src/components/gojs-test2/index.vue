<template>
  <div class="core-circle">
    ...
    <div class="core-circle__tips">
      ...
      <div class="core-circle__tip" style="border-color: #faad14">
        积极响应人
      </div>
      <div class="core-circle__tip" style="border-color: #4090ff">
        积极现场参与人
      </div>
    </div>
    <!-- 关系图gojs -->
...
export default {
  ...
  methods: {
    ...
    onSelectionChanged(e, node) {
      ...
      let pos = this.myGo.transformDocToView(
    ...
    this.myGo.nodeTemplate = g(
      ...
      "Vertical",
      {
        ...
        click: function (e, node) {
          const position = vm.myGo.transformDocToView(
            node.getDocumentPoint(go.Spot.Center)
          );
          // 设置弹窗位置
